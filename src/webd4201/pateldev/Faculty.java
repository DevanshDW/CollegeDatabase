...
/**
 * This is a class for faculty which inherits the method and attributes of  User class .
 * It gets the details for faculty such as name, email, Id number, department, office, dates for login and phone number.
